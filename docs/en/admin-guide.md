...
For administrator issues (authentication, user creation, draw generation, etc.), see the [Troubleshooting Guide - Administrator Issues](troubleshooting.md#administrator-issues).
