...
Fonctionnalité: consultation des tirages
  ...
  Scénario: Alice consulte les tirages auxquels elle participe
    ...
    Et un tirage "Réveillon" pour le 31/12 à venir auquel ils participent tous sauf Bob
    ...
    Et elle voit Bob, Charlie, David, Eve et elle-même dans la liste des participants
