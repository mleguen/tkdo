...
import { jeSuisSurLaPageListeDIdeesPour, uneIdeeAEteProposeeParPour, uneIdeeAEteSuprimeeParPour } from 'cypress/preconditions/liste-idees.pre';
...
describe("liste d'idées", () => {
  ...
  it("proposer des idées pour soi et en supprimer", () => {
    cy.fixture('utilisateurs').then(utilisateurs => {
      ...
      cy.fixture('idees').then(idees => {
        ...
        listeIdeesPage.boutonSupprimerIdee(idees.soi.aSupprimer).should('exist');
  ...
  it("proposer une idée pour un tiers et pouvoir supprimer une idée seulement si on l'a proposée soi-même", () => {
    cy.fixture('utilisateurs').then(utilisateurs => {
      ...
      cy.fixture('idees').then(idees => {
        ...
        listeIdeesPage.boutonSupprimerIdee(idees.tiers.aSupprimer).should('exist');
        ...
        listeIdeesPage.boutonSupprimerIdee(idees.tiers.nonSupprimable).should('not.exist');
      });
    });
  });
  ...
  it("proposer une idée pour celui qui reçoit de soi", () => {
    cy.fixture('utilisateurs').then(utilisateurs => {
      ...
      cy.fixture('idees').then(idees => {
        ...
        listeIdeesPage.descriptionNouvelleIdee().type(idees.quiRecoitDeSoi.aCreer);
        listeIdeesPage.boutonAjouterNouvelleIdee().click();
  ...
  it("un tiers voit les idées créées pour soi, mais plus celles supprimées", () => {
    cy.fixture('utilisateurs').then(utilisateurs => {
      cy.fixture('idees').then(idees => {
        etantDonneQue(
          uneIdeeAEteProposeeParPour(idees.soi.aCreer, utilisateurs.soi, utilisateurs.soi),
          uneIdeeAEteSuprimeeParPour(idees.soi.aSupprimer, utilisateurs.soi, utilisateurs.soi),
  ...
  it("celui qui reçoit de soi voit les idées proposée pour un tiers, mais plus celles supprimées", async () => {
    cy.fixture('utilisateurs').then(utilisateurs => {
      cy.fixture('idees').then(idees => {
        etantDonneQue(
          uneIdeeAEteProposeeParPour(idees.tiers.aCreer, utilisateurs.soi, utilisateurs.tiers),
          uneIdeeAEteSuprimeeParPour(idees.tiers.aSupprimer, utilisateurs.soi, utilisateurs.tiers),
  ...
  it("celui qui reçoit de soi ne voit pas les idées proposées pour lui", async () => {
    cy.fixture('utilisateurs').then(utilisateurs => {
      cy.fixture('idees').then(idees => {
        etantDonneQue(
          uneIdeeAEteProposeeParPour(idees.quiRecoitDeSoi.aCreer, utilisateurs.soi, utilisateurs.quiRecoitDeSoi),
          jeSuisConnecteEnTantQue(utilisateurs.quiRecoitDeSoi),
