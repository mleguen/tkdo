...
final class Version20201025220841 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tkdo_resultat DROP FOREIGN KEY FK_C30A2EFD4034998F');
        ...
        $this->addSql('ALTER TABLE tkdo_resultat DROP FOREIGN KEY FK_C30A2EFD6417A899');
        $this->addSql('ALTER TABLE tkdo_resultat DROP FOREIGN KEY FK_C30A2EFD891C8F2');
