...
final class Version100 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tkdo_idee (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, auteur_id INT DEFAULT NULL, description VARCHAR(255) NOT NULL, dateProposition DATETIME NOT NULL, INDEX IDX_D67D66B9FB88E14F (utilisateur_id), INDEX IDX_D67D66B960BB6FE6 (auteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tkdo_resultat_tirage (id INT AUTO_INCREMENT NOT NULL, occasion_id INT DEFAULT NULL, quiOffre_id INT DEFAULT NULL, quiRecoit_id INT DEFAULT NULL, INDEX IDX_C560DB6A4034998F (occasion_id), INDEX IDX_C560DB6A6417A899 (quiOffre_id), INDEX IDX_C560DB6A891C8F2 (quiRecoit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
