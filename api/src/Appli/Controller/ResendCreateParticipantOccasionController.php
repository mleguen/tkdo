...
class ResendCreateParticipantOccasionController extends AuthController
{
    ...
    public function __invoke(ServerRequestInterface $request, ResponseInterface $response, $args): ResponseInterface
    {
        ...
        catch (UtilisateurInconnuException | PasParticipantException | OccasionPasseeException $err) {
